package com.example.clime.module.utility3.controller;
...
import com.example.clime.module.utility3.service.SpotQuoteService;
...
@RestController("utility3SpotQuoteController")
@RequestMapping("/api/utility3")
public class SpotQuoteController {
    
    @Autowired
    @Qualifier("utility3SpotQuoteService")
